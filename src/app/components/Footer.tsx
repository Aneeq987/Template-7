...
export default function Footer() {
  return (
    <div className="relative flex flex-col items-center justify-center gap-6 px-5 w-full bg-white py-6">
      <div className="first w-full flex flex-wrap items-start justify-between max-w-7xl mx-auto gap-6">
        {/* Intro Section */}
        ...
        <div className="lists flex flex-wrap gap-16 justify-center lg:justify-between w-full lg:w-auto lg:mr-10">
          <div className="about">
      ...
      <div className="last w-full flex flex-wrap items-center justify-between max-w-7xl mx-auto gap-4">
